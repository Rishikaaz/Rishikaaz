...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/rishika-patel)
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:rishika.patel2419@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Rishikaaz)
...
🎓 **B.Tech in Computer Science and Engineering | Cybersecurity & Ethical Hacking**
...
![Linux Shell](https://img.shields.io/badge/Shell_Script-121011?style=flat-square&logo=gnu-bash&logoColor=white)
...
![Scapy](https://img.shields.io/badge/Scapy-CC0000?style=flat-square&logo=white)
![Hashcat](https://img.shields.io/badge/Hashcat-FFA500?style=flat-square&logo=black)
...
### 🧠 Core Concepts
`VAPT` • `Malware Analysis` • `Reverse Engineering` • `Threat Detection` • `OWASP Top 10` • `Network Traffic Analysis` • `TCP/IP & OSI Model` • `Socket Programming`
...
* **Containerized HIDS & SIEM Pipeline** `Python` `Docker Compose` `ELK Stack` `Scapy` `Nmap`
  * Engineered a containerized SIEM architecture cutting host CPU/RAM overhead by 40%.
  * Developed a Scapy-based Python HIDS sensor capturing live traffic and streaming JSON alerts over TCP.
* **Vulnerability Management Platform** `Python` `SQLite` `Network Security` `Socket Programming`
  * Automated reconnaissance, asynchronous port scanning, CVE signature matching, and HTTP header auditing.
  * Integrated an SQLite schema to track findings, reducing manual vulnerability reporting effort by 50%.
* **Behavioral Anomaly Detection Engine** `Python` `Scikit-learn` `Pandas` `Scapy` `SIEM`
  * Built an end-to-end threat detection pipeline converting raw packets into behavioral features for unsupervised models (Isolation Forest, Autoencoders) to catch zero-day anomalies.
  * Streamed real-time JSON alert logs into SIEM pipelines, cutting false positives and boosting response time by 60%.
...
* **Vellore Institute of Technology, Bhopal** | B.Tech in Computer Science and Engineering *(2023 - 2027)*
  * **CGPA:** 8.84 / 10
...
### 🎯 Competitions & Honors
* **OpenBugBounty:** Identified and responsibly disclosed a Cross-Site Scripting (XSS) vulnerability, earning the Fastest Fix Badge.
* **Hackathons & Programs:** Selected for DSCI Cyber For Her Hackathon, Honeywell Hackathon, APCSIP-2026 Cyber Cell Internship, and qualified for Round 2 of Scripted By{Her} 2.0 and Meesho Hackathon.
* **TryHackMe:** Top 2% globally (177-day streak) and placed 355th/5,947 in the Industrial-Intrusion CTF.
* **Shell n'Zen CTF:** Secured 7th rank nationally solving web security and reverse engineering challenges.

### 📜 Certifications
* **Security & Education:** Certified Cybersecurity Educator Professional (CCEP) | Cyber Threat Management (CISCO) | Cybersecurity Job Simulation (Mastercard & Deloitte)
* **Cloud & Infrastructure:** AWS Cloud Practitioner & AWS Skill Builder
* **Networking:** The Bits and Bytes of Computer Networking (Coursera) | Networking Basics (CISCO)
* **Emerging Tech:** Blockchain and its Applications (NPTEL, IIT Kharagpur)
